...
import 'package:news_app/pages/widgets/build_ekonomi_item.dart';
import 'package:news_app/pages/widgets/build_nasional_item.dart';
      ...
      children: [
        Container(
          ...
          child: const CircleAvatar(
            radius: 30,
            backgroundImage: AssetImage('assets/ic/profile.jpeg'),
          ),
        ),
        Column(
          ...
          child: TabBarView(
            ...
            children: [
              ...
              Consumer<EkonomiNewsProvider>(
                builder: (context, ekonomiUpdate, child) {
                  if (ekonomiUpdate.isLoading) {
                    return const Center(
                      child: CircularProgressIndicator(),
                    );
                  } else if (ekonomiUpdate.ekonomiList.isEmpty) {
                    return const Text('No Data');
                  } else {
                    return BuildEkonomiItem(
                        berita: ekonomiUpdate.ekonomiList.first);
                  }
                },
              ),
