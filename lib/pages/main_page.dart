...
class _MainPageState extends State<MainPage> {
  ...
  final Map<String, String> biodata = {
    'name': 'Atikah Fitriani',
    'image':
        'assets/ic/profile.jpeg', // Pastikan gambar ini ada di assets dan terdaftar di pubspec.yaml
    'nim': '212221035',
    'prodi': 'Informatika',
    'fakultas': 'FMIKOM',
    'angkatan': '2021',
    'phone': '085842442958',
    'addr': 'Desa Cindaga Rt 01 Rw 02 Kecamatan Kebasen Kabupaten Banyumas',
  };
  ...
  void initState() {
    ...
    _pages = <Widget>[
      ...
      // Container(),
      // Container(),
      ProfilePage(biodata: biodata), // Menambahkan biodata ke ProfilePage
    ];
  }
